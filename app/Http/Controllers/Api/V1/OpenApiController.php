    ...
    private function spec(): array
    {
        ...
        return [
            ...
            'paths' => [
                ...
                '/notifications' => ['get' => ['summary' => 'This person\'s notifications (unread count in meta)', 'tags' => ['App'], 'security' => $secured, 'parameters' => [$this->q('unread')], 'responses' => ['200' => $ok]]],
                '/notifications/{id}/read' => ['post' => ['summary' => 'Mark one read', 'tags' => ['App'], 'security' => $secured, 'parameters' => [$this->path('id')], 'responses' => ['200' => $ok]]],
                '/notifications/read-all' => ['post' => ['summary' => 'Mark all read', 'tags' => ['App'], 'security' => $secured, 'responses' => ['200' => $ok]]],
                '/reports' => ['get' => ['summary' => 'The reports page as data, for a preset or a range', 'tags' => ['Reports'], 'security' => $secured, 'parameters' => [$this->q('preset'), $this->q('from'), $this->q('to')], 'responses' => ['200' => $ok, '403' => $ok]]],
                '/reports/pdf' => ['get' => ['summary' => 'The report as a PDF', 'tags' => ['Reports'], 'security' => $secured, 'parameters' => [$this->q('from'), $this->q('to')], 'responses' => ['200' => $ok]]],
                '/beds' => ['get' => ['summary' => 'Wards and their beds, with live occupancy', 'tags' => ['Inpatient'], 'security' => $secured, 'responses' => ['200' => $ok]]],
                '/admissions/{uuid}/transfer' => ['post' => ['summary' => 'Move a patient to another bed', 'tags' => ['Inpatient'], 'security' => $secured, 'parameters' => [$this->path('uuid')], 'responses' => ['200' => $ok, '422' => $ok]]],
                '/admissions/{uuid}/discharge' => ['post' => ['summary' => 'Close an admission (discharged, deceased, absconded)', 'tags' => ['Inpatient'], 'security' => $secured, 'parameters' => [$this->path('uuid')], 'responses' => ['200' => $ok, '422' => $ok]]],
