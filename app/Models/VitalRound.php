 ...
 */
class VitalRound extends Model
{
    ...
    protected $fillable = [
        ...
        'uuid',
        'admission_id', 'temperature', 'pulse', 'blood_pressure', 'respiratory_rate', 'spo2', 'note', 'recorded_by', 'created_at',
    ];

    protected function casts(): array
    {
        return ['temperature' => 'decimal:1', 'created_at' => 'datetime',
